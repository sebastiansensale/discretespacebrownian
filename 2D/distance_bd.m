...
for factor=1:1
    ...
    for i=1:trajectories
        ...
        while nostop
            ...
            clearvars -except j timeA timeB coordA coordB i trajectories nostop D delta limit endtime  TIM factor
        end;
        
        TIM(i)=endtime;
        clearvars -except TIM i trajectories factor D delta limit
    end;
    Tim=TIM(TIM~=0);
